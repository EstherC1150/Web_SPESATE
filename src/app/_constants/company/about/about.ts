...
export const values: TValue[] = [
  {
    ...
    content: [
      {
        subTitle: "데이터 기반으로 문제를 분석하고 해결",
        subContent:
          "데이터 분석을 통해 문제의 근본 원인을 정확하게 파악하고, 최적의 해결책을 제시",
      },
      {
        subTitle: "복잡한 문제를 체계적이고 종합적인 솔루션으로 해결",
        subContent:
  ...
  },
  {
    ...
    content: [
      {
        subTitle: "객관적인 데이터 분석을 바탕으로 의사결정 지원",
        subContent:
          "주관적인 판단을 배제하고, 객관적인 데이터 분석을 기반으로 의사 결정을 지원",
      },
      {
        subTitle: "고객의 상황을 정확히 분석하고 객관적인 해결책 제시",
        subContent:
          "다양한 경영 환경 변수를 고려하여 문제의 복합성을 해결하고, 지속 가능한 성장을 위한 맞춤형 솔루션을 제공",
      },
    ],
  ...
  },
  {
    ...
    content: [
      {
        subTitle: "투명하고 공정한 과정을 통해 신뢰 구축",
        subContent:
          "모든 컨설팅 과정을 투명하게 운영하고, 고객에게 명확한 정보를 제공하여 신뢰를 구축",
      },
      {
        subTitle: "지속 가능한 장기적 파트너십을 통해 신뢰 쌓기",
        subContent:
  ...
  },
  {
    ...
    content: [
      {
        subTitle: "빠르고 정확하게 문제 해결",
        subContent:
          "최신 컨설팅 기법과 도구를 활용하여 문제를 신속하게 파악하고, 효율적인 해결책을 제시",
      },
      {
        subTitle: "최소 자원으로 최대 효과 창출",
  ...
  },
  {
    ...
    content: [
      {
        subTitle: "미래 트렌드를 분석하고 혁신적 솔루션 제공",
        subContent:
  ...
  },
  {
    ...
    content: [
      ...
      {
        subTitle: "고객 맞춤형 솔루션 제공하여 가치를 극대화",
        subContent:
